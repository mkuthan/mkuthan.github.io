...
Below you can find my notes from several interesting sessions and overall impression on conference itself.
...
* Goals - sub-seconds latency, petabyte scale, ANSI SQL.
...
* [Apache Calcite](https://calcite.apache.org/docs/druid_adapter.html) is a key player of the integration.
* Pros: schema discovery.
* Cons: dims/metrics are inferred, no way to specify all important index details (e.g: time granularities).
* Roadmap: push down more things into the Druid for better query performance.
See also: [https://cwiki.apache.org/confluence/display/Hive/Druid+Integration](https://cwiki.apache.org/confluence/display/Hive/Druid+Integration)
...
* Contribution to Spark in IBM way (closed solutions, heavily dependant on IBM JVM and hardware).
* Spark-kit (e.g custom block manager).
[https://www.ibm.com/developerworks/java/jdk/spark/](https://www.ibm.com/developerworks/java/jdk/spark/)
...
* [R/Shiny](http://shiny.rstudio.com/) for analytical purposes and presentation.
...
* [BigPetStore](https://github.com/apache/bigtop/tree/master/bigtop-bigpetstore) - generates synthethic data + sample stats calculation + recommendation.
* MR, Spark, [Flink](https://github.com/bigpetstore/bigpetstore-flink) implementations - nice method to learn Flink if you know Spark (or opposite).
...
* Conflict-Free Replicated JSON Datatype was mentioned by Jan during talk.
[https://arxiv.org/pdf/1608.03960.pdf](https://arxiv.org/pdf/1608.03960.pdf)
