...
You will get an error because table doesn't exist yet, it will be created just before the first insert.
...
Why we've to pay for the whole message delivery if timestamp attribute is enough for tracking? I don't know.
{: .notice--info}
